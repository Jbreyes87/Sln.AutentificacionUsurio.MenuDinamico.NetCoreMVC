...
namespace Emsoir.Infraestructura.Repository
{
    public class ArticuloRepositorio : IArticuloRepositorio
    {
        ...
        {
            string sql= @"select b.ArticuloId as Id, b.Nombre,b.Descripcion,convert(nvarchar(MAX), b.FechaCreacion, 1) as FechaCreacion,b.UrlImagen,a.Descripcion as NombreCategoria from Categorias a 
